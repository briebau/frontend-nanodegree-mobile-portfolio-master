...
var resizePizzas = function(size) { 
  ...
  var pizzaContainer = document.getElementsByClassName("randomPizzaContainer"); // Created var pizzaContainer and moved variables out of the for loop
...
var pizzasDiv = document.getElementById("randomPizzas"); // Moved this line outside of the for loop

// This for-loop actually creates and appends all of the pizzas when the page loads

for (var i = 2; i < 24; i++) { // Lowered the number of pizzas since it doesn't change the appearance of the original page
...
function updatePositions() {
  ...
  var scroll = document.body.scrollTop/1250; // Created var scroll so that the equation assigned to var phase is shorter
  var phase =[];
  var items = document.getElementsByClassName('mover');

  for (var i = 0; i <35; i++) { //changed items.length to 35 as more is not needed
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPizzas = document.getElementById("movingPizzas1"); // Declare variables outside of the for loop
  var elem;

  // changed from 120 t0 40 as this if max amount of pizzas
  for (var i = 0; i <40; i++) {
